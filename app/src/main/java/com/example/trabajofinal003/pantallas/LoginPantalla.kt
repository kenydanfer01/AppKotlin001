...
import com.example.trabajofinal003.componentes.login.LoginVistaModelo
import kotlinx.coroutines.launch

@Composable
fun LoginPantalla(navController: NavController) {
    Scaffold {
        LoginScreen(LoginVistaModelo())
    }
}
@Composable
fun LoginScreen(viewModel: LoginVistaModelo) {
    Box(
        Modifier
            .fillMaxSize()
            .padding(16.dp)
...
@Composable
fun Login(modifier: Modifier, viewModel: LoginVistaModelo) {
